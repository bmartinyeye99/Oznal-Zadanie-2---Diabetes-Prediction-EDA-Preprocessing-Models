...
data_balanced$Diabetes <- factor(data_balanced$Diabetes, levels = c(0, 1))
...
svm_model <- train(form = formula, 
                   data = data_balanced, 
                   method = "svmRadialSigma", # mame vela kategorickych predikatov vo formule
                   trControl = ctrl,
...
# Sort the results by ROC
sorted_results <- resample_results[order(-resample_results$ROC), ]

# Print or access the best-performing combination
best_combination <- sorted_results[1, ]
